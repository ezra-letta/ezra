...
- [`demos/legacy-archival-memory-mod/`](demos/legacy-archival-memory-mod/) -- Install agent-scoped tools that search, browse, and optionally append to an existing legacy archival-memory store.
