...
- [`demos/python-wheel-cli-smoke/`](demos/python-wheel-cli-smoke/) -- Install the self-contained Letta Code Python wheel into a disposable environment and verify `letta` works while system Node and npm are hidden.
